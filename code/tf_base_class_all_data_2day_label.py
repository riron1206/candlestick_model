...
Usage:
    ...
    # 指定ディレクトリについてモデル予測
    $ python tf_base_class_all_data_2day_label.py -m predict

    # optunaでパラメータチューニング
    # 変更するパラメータは Objective.get_class_fine_tuning_parameter_suggestions() で変更する
    $ python tf_base_class_all_data_2day_label.py -m tuning -n_t 50 -t_out_dir D:\work\candlestick_model\output\model\ts_dataset_all_2day_label\optuna
"""
import os
import sys
import time
...
class Objective(object):
    ...
    def get_class_fine_tuning_parameter_suggestions(self, trial) -> dict:
        ...
        return {
            ...
            # "classes": ["0", "1"],
            # "num_classes": 2,
            "train_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_2day_label\train",
            "validation_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_2day_label\test",
            "color_mode": "rgb",
...
if __name__ == "__main__":
    ...
    # パラメータ.py import
    if p_args.param == "param_2day_label.py":
        import param_2day_label as param_py
    elif p_args.param == "param_2day_label_trainable45.py":
        import param_2day_label_trainable45 as param_py
    elif p_args.param == "param_2day_label_trainable65.py":
        import param_2day_label_trainable65 as param_py
    elif p_args.param == "param_2day_label_trainable85.py":
        import param_2day_label_trainable85 as param_py
    elif p_args.param == "param_2day_label_trainable105.py":
        import param_2day_label_trainable105 as param_py
    elif p_args.param == "param_2day_label_trainable125.py":
        import param_2day_label_trainable125 as param_py
