...
Usage:
    ...
    $ python tf_base_class_all_data_2day_label_binary.py -m train
    ※最適な学習率確認する場合はget_class_fine_tuning_parameter_base()のis_lr_finderをtrueにする

    # 指定ディレクトリについてモデル予測
    $ python tf_base_class_all_data_2day_label_binary.py -m predict

    # optunaでパラメータチューニング
    # 変更するパラメータは Objective.get_class_fine_tuning_parameter_suggestions() で変更する
    $ python tf_base_class_all_data_2day_label_binary.py -m tuning -n_t 50 -t_out_dir D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_binary\optuna
"""
import os
import sys
import time
...
def get_class_fine_tuning_parameter_base() -> dict:
    ...
    return {
        "output_dir": r"D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_binary",
        # "output_dir": r"D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_binary\model_paper",
        "gpu_count": 1,
        "img_rows": 80,
        "img_cols": 80,
        "channels": 3,
        ...
        # "classes": ["0", "1"],
        # "num_classes": 2,
        "train_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_2day_label_binary\train",
        "validation_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_2day_label_binary\test",
        "test_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_2day_label_binary\test",
        "color_mode": "rgb",
        ...
        "model_path": None,
        # 初期モデル指定する！！！
        # "model_path": r"D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_binary\best_val_loss_20200727.h5",
        "num_epoch": 200,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=r"D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_binary\optuna",
    )
