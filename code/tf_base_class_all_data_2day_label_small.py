...
Usage:
    ...
    $ python tf_base_class_all_data_2day_label_small.py -m train
    ※最適な学習率確認する場合はget_class_fine_tuning_parameter_base()のis_lr_finderをtrueにする

    # 指定ディレクトリについてモデル予測
    $ python tf_base_class_all_data_2day_label_small.py -m predict

    # optunaでパラメータチューニング
    # 変更するパラメータは Objective.get_class_fine_tuning_parameter_suggestions() で変更する
    $ python tf_base_class_all_data_2day_label_small.py -m tuning -n_t 50 -t_out_dir D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_small\optuna
    $ python tf_base_class_all_data_2day_label_small.py -m tuning -n_t 100 -t_out_dir D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_small_class2_reduce\optuna
"""
import os
import sys
import time
...
class Objective(object):
    ...
    def get_class_fine_tuning_parameter_suggestions(self, trial) -> dict:
        ...
        return {
            ...
            # optimizer param
            # "choice_optim": "sgd",
            "choice_optim": trial.suggest_categorical(
                "choice_optim", ["sgd", "adam", "adamax"]  # , "nadam"
            ),
            # "lr": 1e-2,
...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=r"D:\work\candlestick_model\output\model\ts_dataset_all_2day_label\optuna",
    )
    parser.add_argument(
        "-p",
        "--param",
        help="param config py",
        type=str,
        default="param_2day_label_small.py",
    )
...
if __name__ == "__main__":
    ...
    # パラメータ.py import
    if p_args.param == "param_2day_label_small.py":
        import param_2day_label_small as param_py
    elif p_args.param == "param_2day_label_small_trainable25.py":
        import param_2day_label_small_trainable25 as param_py
    elif p_args.param == "param_2day_label_small_trainable45.py":
        import param_2day_label_small_trainable45 as param_py
    elif p_args.param == "param_2day_label_small_trainable65.py":
        import param_2day_label_small_trainable65 as param_py
    elif p_args.param == "param_2day_label_small_trainable85.py":
        import param_2day_label_small_trainable85 as param_py
    elif p_args.param == "param_2day_label_small_trainable105.py":
        import param_2day_label_small_trainable105 as param_py
    elif p_args.param == "param_2day_label_small_trainable125.py":
        import param_2day_label_small_trainable125 as param_py
    ...
    parser.add_argument(
        ...
        help="Optuna trials output_dir",
        type=str,
        default=r"D:\work\candlestick_model\output\model\ts_dataset_all_2day_label_small\optuna",
    )
    parser.add_argument(
