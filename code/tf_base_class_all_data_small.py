...
Usage:
    ...
    $ python tf_base_class_all_data_small.py -m train
    ※最適な学習率確認する場合はget_class_fine_tuning_parameter_base()のis_lr_finderをtrueにする

    # 指定ディレクトリについてモデル予測
    $ python tf_base_class_all_data_small.py -m predict

    # optunaでパラメータチューニング
    # 変更するパラメータは Objective.get_class_fine_tuning_parameter_suggestions() で変更する
    $ python tf_base_class_all_data_small.py -m tuning -n_t 2 -t_out_dir D:\work\candlestick_model\output\model\ts_dataset_small\optuna
"""
import os
import sys
import time
...
def get_class_fine_tuning_parameter_base() -> dict:
    ...
    return {
        "output_dir": r"D:\work\candlestick_model\output\model\ts_dataset_small",
        "gpu_count": 1,
        "img_rows": 80,
        "img_cols": 80,
        "channels": 3,
        ...
        "classes": ["0", "1", "2"],
        "num_classes": 3,
        "train_data_dir": r"D:\work\candlestick_model\output\ts_dataset_small\train",
        "validation_data_dir": r"D:\work\candlestick_model\output\ts_dataset_small\validation",
        "test_data_dir": r"D:\work\candlestick_model\output\ts_dataset_small\test",
        "color_mode": "rgb",
    ...
    def get_class_fine_tuning_parameter_suggestions(self, trial) -> dict:
        ...
        return {
            ...
            "choice_model": trial.suggest_categorical(
                "choice_model",
                ["model_paper"],
                # ["model_paper", "VGG16", "ResNet50", "Xception", "InceptionV3"],
            ),
            "fcpool": "GlobalAveragePooling2D",
            "is_skip_bn": False,
            "trainable": "all",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=r"D:\work\candlestick_model\output\model\ts_dataset_small\optuna",
    )
