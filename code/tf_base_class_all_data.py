...
Usage:
    ...
    $ python tf_base_class_all_data.py -m tuning -n_t 50 -t_out_dir D:\work\candlestick_model\output\model\ts_dataset_all_test\optuna
"""
import os
import sys
import time
...
def get_class_fine_tuning_parameter_base() -> dict:
    ...
    return {
        "output_dir": r"D:\work\candlestick_model\output\model\ts_dataset_all_test",
        "gpu_count": 1,
        "img_rows": 80,
        "img_cols": 80,
        "channels": 3,
        ...
        "classes": ["0", "1", "2"],
        "num_classes": 3,
        "train_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_test\train",
        "validation_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_test\test",
        "test_data_dir": r"D:\work\candlestick_model\output\ts_dataset_all_test\test",
        "color_mode": "rgb",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=r"D:\work\candlestick_model\output\model\ts_dataset_all_test\optuna",
    )
